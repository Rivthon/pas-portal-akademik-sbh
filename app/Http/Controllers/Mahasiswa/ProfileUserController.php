...
class ProfileUserController extends Controller
{
    public function index()
    {
        ...
        activity_log('lihat_profil', 'Mahasiswa melihat data profil');
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            activity_log('update_profil', 'Mahasiswa memperbarui data profil');
    ...
    public function smtUpdate(Request $request)
    {
        ...
        try {
            ...
            activity_log('update_semester', 'Mahasiswa memperbarui semester menjadi '.$request->semester);

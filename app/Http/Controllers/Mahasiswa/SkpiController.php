...
class SkpiController extends Controller
{
    public function index()
    {
        ...
        activity_log('lihat_skpi', 'Mahasiswa mengakses halaman SKPI');
    ...
    public function edit_sertifikasi($id)
    {
        ...
        $sertifikasi = $this->ownedRecord(Sertifikasi::class, $id);
    ...
    public function update_sertifikasi(Request $request, $id)
    {
        ...
        $data['status_validasi'] = 'Menunggu';        // default
        $data['bobot'] = 0;                 // belum diisi validator
        $this->ownedRecord(Sertifikasi::class, $id)->update($data);
    ...
    public function edit_bahasa($id)
    {
        ...
        $bahasa = $this->ownedRecord(PenguasaanBahasa::class, $id);
    ...
    public function update_bahasa(Request $request, $id)
    {
        ...
        $data['status_validasi'] = 'Menunggu';        // default
        $data['bobot'] = 0;                 // belum diisi validator
        $this->ownedRecord(PenguasaanBahasa::class, $id)->update($data);
    ...
    public function edit_wirausaha($id)
    {
        ...
        $wirausaha = $this->ownedRecord(P2mwProgram::class, $id);
    ...
    public function update_wirausaha(Request $request, $id)
    {
        ...
        $data['status_validasi'] = 'Menunggu';        // default
        $data['bobot'] = 0;                 // belum diisi validator
        $this->ownedRecord(P2mwProgram::class, $id)->update($data);
    ...
    public function edit_pkm($id)
    {
        ...
        $pkm = $this->ownedRecord(PkmProgram::class, $id);
    ...
    public function update_pkm(Request $request, $id)
    {
        ...
        $data['status_validasi'] = 'Menunggu';        // default
        $data['bobot'] = 0;                 // belum diisi validator
        $this->ownedRecord(PkmProgram::class, $id)->update($data);
    ...
    public function edit_ppsm($id)
    {
        ...
        $pkm = $this->ownedRecord(Ppsm::class, $id);
    ...
    public function update_ppsm(Request $request, $id)
    {
        ...
        $data['status_validasi'] = 'Menunggu';        // default
        $data['bobot'] = 0;                 // belum diisi validator
        $this->ownedRecord(Ppsm::class, $id)->update($data);
    ...
    public function edit_tambahan($id)
    {
        ...
        $tambahan = $this->ownedRecord(KegiatanTambahan::class, $id);

        return view('mahasiswa.skpi.kegiatan-tambahan.edit', compact('settings', 'mahasiswa', 'semester', 'prodi', 'ta', 'tambahan'));
    }
    ...
    public function update_tambahan(Request $request, $id)
    {
        ...
        $data['status_validasi'] = 'Menunggu';        // default
        $data['bobot'] = 0;                 // belum diisi validator
        $this->ownedRecord(KegiatanTambahan::class, $id)->update($data);
        Alert::success('PPSM berhasil diubah')
            ->autoclose(3000);
    ...
    {
        $pkm = $this->ownedRecord(KegiatanTambahan::class, $id);
        $pkm->delete();
    ...
    public function cetak()
    {
        ...
        $pdf = PDF::loadView('mahasiswa.skpi.cetak-skpi', compact(
            'mahasiswa', 'ta', 'logoBase64',
            'sertifikasi', 'ppsm', 'bahasa', 'p2mw', 'pkm',
            'tambahan', 'totalWajib', 'totalTambahan', 'totalSkor'
        ))->setPaper('A4', 'portrait');

        activity_log('cetak_skpi', 'Mahasiswa mencetak laporan SKPI');

        return $pdf->stream('laporan-skpi-'.$mahasiswa->nama.'.pdf');
    }

    /**
     * Resolve an SKPI record only inside the authenticated student's scope.
     * A 404 response avoids disclosing whether another student's ID exists.
     *
     * @param  class-string<Model>  $modelClass
     */
    private function ownedRecord(string $modelClass, $id): Model
    {
        $mahasiswaId = Auth::guard('mahasiswa')->user()->mahasiswa_id;

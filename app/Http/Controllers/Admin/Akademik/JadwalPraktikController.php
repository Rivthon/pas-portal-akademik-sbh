...
class JadwalPraktikController extends Controller
{
    public function index()
    {
        try {
            ...
            return view('admin.akademik.jadwal-praktik.index', compact('programStudi', 'tahunAjaran', 'matakuliah', 'ruangan', 'programStudi'));
        } catch (\Exception $e) {
    ...
    public function filter(Request $request)
    {
        try {
            ...
            $jadwalPraktik = JadwalPraktik::select(
                ...
                ->orderByRaw("CASE LOWER(TRIM(COALESCE(jadwal_praktik.hari, '')))
                    WHEN 'senin' THEN 1
                    WHEN 'selasa' THEN 2
                    WHEN 'rabu' THEN 3
                    WHEN 'kamis' THEN 4

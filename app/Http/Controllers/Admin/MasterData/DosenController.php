...
class DosenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'html' => view('admin.master-data.dosen.partials_list', compact('dosen'))->render()
            ]);
        }
    ...
    public function create(): View
    {
        ...
        return view('admin.master-data.dosen.form', compact('programStudi'));
    }

    public function edit(Dosen $dosen): View
    {
        $programStudi = ProgramStudi::all();
        return view('admin.master-data.dosen.form', compact('dosen', 'programStudi'));
    }

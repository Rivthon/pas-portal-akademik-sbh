...
class KurikulumController extends Controller
{
   ...
   public function index()
    ...
    public function create(Request $request)
    {
        ...
        if (!$tahunAjaranAktif) {
            return redirect()->route('kurikulum.index')->with('error', 'Tahun Ajaran aktif tidak ditemukan.');
        }
        $kurikulum = new Kurikulum(); // Untuk form create
        return view('kurikulum.form', compact('kurikulum', 'programStudi', 'mataKuliah', 'ruangan', 'tahunAjaranAktif'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('kurikulum.form', compact(
            'kurikulum',
            'programStudi',
            'mataKuliah',
            // 'ruangan',

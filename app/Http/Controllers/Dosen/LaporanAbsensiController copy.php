...
class LaporanAbsensiController extends Controller
{
    ...
    public function generatePDF(Request $request)
    {
        ...
        // Generate PDF
        activity_log('cetak_absensi_teori', 'Dosen mencetak laporan absensi teori jadwal ID: '.$request->jadwal_id);
    ...
    public function generatePraktikPDF(Request $request)
    {
        ...
        // Generate PDF
        activity_log('cetak_absensi_praktik', 'Dosen mencetak laporan absensi praktik jadwal ID: '.$request->jadwal_praktik_id);

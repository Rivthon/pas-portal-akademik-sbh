...
class PermissionCatalog
{
    ...
    public static function label(string $permission): string
    {
        $overrides = [
            ...
            'aktivasi-uap-list' => 'Lihat aktivasi UAP Kebidanan',
            'aktivasi-uap-update' => 'Ubah aktivasi UAP Kebidanan',
            'aktivasi-uap-bulk-update' => 'Ubah massal aktivasi UAP Kebidanan',
            ...
            'dosen-impersonate' => 'Login sebagai dosen',

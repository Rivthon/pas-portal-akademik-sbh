...
<div class="flex-grow-1 container-p-y ">
            ...
            <div class="col-md-7">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4" style="line-height: 1.6;">
                        ...
                        Selamat datang di halaman validator SKPI (Surat Keterangan Pendamping Ijazah) untuk
                        mahasiswa yang telah menyelesaikan program sertifikasi atau kompetensi di
                        <strong>STIKes Bogor Husada</strong>. Halaman ini bertujuan untuk
                        memudahkan mahasiswa dalam mengajukan permohonan SKPI terkait sertifikasi atau kompetensi yang
                        telah mereka ikuti. Dengan menggunakan sistem ini, mahasiswa dapat mengajukan permohonan
                        SKPI secara online, sehingga prosesnya menjadi lebih cepat dan efisien.
    ...
    <div class="row">
        ...
        [
        'title' => 'Disetujui',
        'route' => route('admin.skpi.sertifikasi.disetujui'),
        'color' => 'success',
        'svg' => '
        ...
        [
        'title' => 'Ditolak',
        'route' => route('admin.skpi.sertifikasi.ditolak'),
        'color' => 'danger',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
        ...
        [
        'title' => 'Ditinjau',
        'route' => route('admin.skpi.sertifikasi.ditinjau'),
        ...
        [
        'title' => 'Menunggu',
        'route' => route('admin.skpi.sertifikasi.menunggu'),
        'color' => 'secondary',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">

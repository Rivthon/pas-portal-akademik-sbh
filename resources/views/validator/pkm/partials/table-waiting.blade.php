    ...
    <table class="table table-bordered table-striped align-middle text-center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->prestasi }}</td>
                <td>
                    <span class="badge bg-waiting">{{ ucfirst($item->status_validasi) }}</span>
                </td>
                <td>
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-light">
                            <h5 class="modal-title text-white" id="detailModalLabel{{ $item->id }}">Detail PKM
                            </h5>
                        ...
                        <div class="modal-body text-start">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8">{{ $item->judul_kegiatan }}</dd>

                                <dt class="col-sm-4">Jenis PKM</dt>
                                <dd class="col-sm-8">{{ $item->jenis_pkm }}</dd>
                                ...
                                <dd class="col-sm-8">
                                    <a href="{{ $item->file_laporan }}" target="_blank"
                                ...
                                <dd class="col-sm-8">
                                    <a href="{{ $item->file_lampiran }}" target="_blank"
                            ...
                            <form action="{{ route('admin.pkm.catatan', $item->id) }}" method="POST">
                                @csrf
                                @method('PUT')

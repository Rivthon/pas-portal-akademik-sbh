...
<div class="flex-grow-1 container-p-y ">
            ...
            <div class="col-md-7">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4" style="line-height: 1.6;">
                        Selamat datang di halaman validator SKPI Program Kreativitas Mahasiswa (PKM). Di sini Anda dapat
                        melihat status PKM yang telah diajukan oleh mahasiswa. Anda dapat mengelola dan memantau
                        perkembangan PKM yang telah diajukan. Silakan pilih salah satu kategori di bawah ini untuk
                        melihat daftar PKM yang sesuai dengan statusnya.
    ...
    <div class="row">
        ...
        [
        'title' => 'Disetujui',
        'route' => route('admin.skpi.pkm.disetujui'),
        'color' => 'success',
        'svg' => '
        ...
        [
        'title' => 'Ditolak',
        'route' => route('admin.skpi.pkm.ditolak'),
        'color' => 'danger',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
        ...
        [
        'title' => 'Ditinjau',
        'route' => route('admin.skpi.pkm.ditinjau'),
        ...
        [
        'title' => 'Menunggu',
        'route' => route('admin.skpi.pkm.menunggu'),
        'color' => 'secondary',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">

                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-light">
                            <h5 class="modal-title text-white" id="detailModalLabel{{ $item->id }}">Detail Kegiatan
                            </h5>
                        ...
                        <div class="modal-body text-start">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8">{{ $item->tahun_kegiatan }}</dd>
                            ...
                            <form action="{{ route('admin.ppsm.catatan', $item->id) }}" method="POST">
                                @csrf
                                @method('PUT')

    ...
    <table class="table table-bordered table-striped align-middle text-center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="badge bg-secondary">{{ ucfirst($item->status_validasi) }}</span>
                </td>
                <td>
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-light">
                            <h5 class="modal-title text-white" id="detailModalLabel{{ $item->id }}">Detail Wirausaha
                            </h5>
                        ...
                        <div class="modal-body text-start">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8">{{ $item->nama_usaha }}</dd>
                                ...
                                <dd class="col-sm-8">{{ $item->status_pendanaan }}</dd>
                            ...
                            <form action="{{ route('admin.wirausaha.catatan', $item->id) }}" method="POST">
                                @csrf
                                @method('PUT')
...
<div class="alert alert-warning text-center">
    Tidak ada data wirausaha ditemukan.
</div>
@endif
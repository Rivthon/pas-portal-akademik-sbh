                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="nisn" name="nisn" value="{{ old('nisn', $mahasiswa->nisn) }}">
                        </div>
                    </div>
                    <!-- NIK -->
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="bx bx-id-card"></i></span>
                            <input type="text" class="form-control" id="nik" name="nik" value="{{ old('nik', $mahasiswa->nik) }}">
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select" id="jurusan_id" name="jurusan_id" required>
                                ...
                                <option value="{{ $j->jurusan_id }}" {{ old('jurusan_id', $mahasiswa->jurusan_id) == $j->jurusan_id ? 'selected' : '' }}>
                                    {{ $j->nama }}
                                </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="bx bx-calendar"></i></span>
                            <input type="number" class="form-control" id="semester" name="semester" value="{{ old('semester', $mahasiswa->semester) }}" min="1" max="8" required>
                        </div>
                    </div>
                    <!-- Tahun Masuk -->
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="tahun_masuk" name="tahun_masuk" value="{{ old('tahun_masuk', $mahasiswa->tahun_masuk) }}" min="2000" max="{{ date('Y') }}" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select" id="status_mhs" name="status_mhs" required>
                                ...
                                <option value="aktif" {{ old('status_mhs', $mahasiswa->status_mhs) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                <option value="nonaktif" {{ old('status_mhs', $mahasiswa->status_mhs) == 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                                <option value="lulus" {{ old('status_mhs', $mahasiswa->status_mhs) == 'lulus' ? 'selected' : '' }}>Lulus</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select" id="pendapatan_ortu" name="pendapatan_ortu" required>
                                ...
                                <option value="Rp 500.000,00 - Rp 1.000.000,00"
                                    {{ old('pendapatan_ortu', $mahasiswa->pendapatan_ortu) == 'Rp 500.000,00 - Rp 1.000.000,00' ? 'selected' : '' }}>
                                    Rp 500.000,00 - Rp 1.000.000,00
                                </option>
                                <option value="Rp 1.000.000,00 - Rp 2.000.000,00"
                                    {{ old('pendapatan_ortu', $mahasiswa->pendapatan_ortu) == 'Rp 1.000.000,00 - Rp 2.000.000,00' ? 'selected' : '' }}>
                                    Rp 1.000.000,00 - Rp 2.000.000,00
                                </option>
                                <option value="Rp 2.000.000,00 - Rp 3.500.000,00"
                                    {{ old('pendapatan_ortu', $mahasiswa->pendapatan_ortu) == 'Rp 2.000.000,00 - Rp 3.500.000,00' ? 'selected' : '' }}>
                                    Rp 2.000.000,00 - Rp 3.500.000,00
                                </option>
                                <option value="Rp 3.500.000,00"
                                    {{ old('pendapatan_ortu', $mahasiswa->pendapatan_ortu) == 'Rp 3.500.000,00' ? 'selected' : '' }}>
                                    Rp 3.500.000,00
                                </option>
                                <option value="Rp 5.000.000,00 - Rp 7.000.000,00"
                                    {{ old('pendapatan_ortu', $mahasiswa->pendapatan_ortu) == 'Rp 5.000.000,00 - Rp 7.000.000,00' ? 'selected' : '' }}>
                                    Rp 5.000.000,00 - Rp 7.000.000,00
                                </option>
                                <option value="Rp 7.000.000,00 - Rp 10.000.000,00"
                                    {{ old('pendapatan_ortu', $mahasiswa->pendapatan_ortu) == 'Rp 7.000.000,00 - Rp 10.000.000,00' ? 'selected' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="bx bx-home"></i></span>
                            <textarea class="form-control" id="alamat_ortu" name="alamat_ortu" rows="3" required>{{ old('alamat_ortu', $mahasiswa->alamat_ortu) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>

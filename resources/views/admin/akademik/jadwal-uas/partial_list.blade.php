    ...
    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
        <div class="card">
            <div class="card-body d-flex align-items-center">
                ...
                <!-- Actions -->
                <div>
                    <form action="{{ route('admin.jadwal-uas.destroy', $item->id) }}" method="POST"
                        style="display:inline;">
                        @csrf
                        @method('DELETE')

                        @can('jadwal-uas-edit')
                        <a class="btn btn-primary btn-sm mb-1" href="{{ route('admin.jadwal-uas.edit', $item->id) }}">

...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white p-4">
        <form method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-md-2"><label class="form-label">Kelas</label><select name="jenis_kelas" class="form-select"><option value="">Semua</option><option value="reguler" @selected(request('jenis_kelas')==='reguler')>Reguler A</option><option value="karyawan" @selected(request('jenis_kelas')==='karyawan')>Reguler B</option></select></div>

...
@section('title', 'Pemahaman Sistem Pembelajaran di Perguruan Tinggi')
@section('content')
<div class="flex-grow-1 container-p-y ">
            ...
            <div class="col-md-7">
                <div class="card-body">
                    ...
                    <h5 class="card-title text-primary mb-3 fw-bold">
                        Pemahaman Sistem Pembelajaran di Perguruan Tinggi </h5>
                        ...
                        <ol class="breadcrumb small">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <span class="breadcrumb-active"
                                    ...
                                    Pemahaman Sistem Pembelajaran di Perguruan Tinggi
                                </span>
                            </li>
                    ...
                    <p class="text-muted mb-4" style="line-height: 1.6;">
                        Selamat datang di halaman validator SKPI Pemahaman Sistem Pembelajaran di Perguruan Tinggi. Di
                        sini
                        Anda dapat melihat status PKM yang telah diajukan oleh mahasiswa. Anda dapat mengelola dan
                        memantau
                        perkembangan PKM yang telah diajukan. Silakan pilih salah satu kategori di bawah ini untuk
                        melihat
                        daftar PKM yang sesuai dengan statusnya.
                        <br>
    ...
    <div class="row">
        ...
        [
        'title' => 'Disetujui',
        'route' => route('admin.skpi.ppsm.disetujui'),
        'color' => 'success',
        'svg' => '
        ...
        [
        'title' => 'Ditolak',
        'route' => route('admin.skpi.ppsm.ditolak'),
        'color' => 'danger',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
        ...
        [
        'title' => 'Ditinjau',
        'route' => route('admin.skpi.ppsm.ditinjau'),
        ...
        [
        'title' => 'Menunggu',
        'route' => route('admin.skpi.ppsm.menunggu'),
        'color' => 'secondary',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">

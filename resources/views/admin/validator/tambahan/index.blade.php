...
<div class="flex-grow-1 container-p-y ">
            ...
            <div class="col-md-7">
                <div class="card-body">
                    ...
                    <h5 class="card-title text-primary mb-3 fw-bold">
                        SKPI Kegiatan Tambahan Mahasiswa
                    </h5>
                    ...
                    <p class="text-muted mb-4" style="line-height: 1.6;">
                        SKPI Kegiatan Tambahan Mahasiswa adalah dokumen yang mencatat kegiatan tambahan yang telah
                        dilakukan oleh mahasiswa di luar kurikulum akademik. Dokumen ini mencakup informasi tentang
                        kegiatan tambahan yang telah disetujui oleh validator, termasuk nama kegiatan, tanggal
                        pelaksanaan, dan deskripsi singkat tentang kegiatan tersebut. SKPI Kegiatan Tambahan
                        Mahasiswa bertujuan untuk memberikan pengakuan resmi terhadap kegiatan tambahan yang telah
                        dilakukan oleh mahasiswa, serta untuk memberikan informasi yang lebih lengkap tentang
                        pengalaman dan kompetensi yang dimiliki oleh mahasiswa tersebut.
                        <br>
    ...
    <div class="row">
        ...
        [
        'title' => 'Disetujui',
        'route' => route('admin.skpi.tambahan.disetujui'),
        'color' => 'success',
        'svg' => '
        ...
        [
        'title' => 'Ditolak',
        'route' => route('admin.skpi.tambahan.ditolak'),
        'color' => 'danger',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
        ...
        [
        'title' => 'Ditinjau',
        'route' => route('admin.skpi.tambahan.ditinjau'),
        ...
        [
        'title' => 'Menunggu',
        'route' => route('admin.skpi.tambahan.menunggu'),
        'color' => 'secondary',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">

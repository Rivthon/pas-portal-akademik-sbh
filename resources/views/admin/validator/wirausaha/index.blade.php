...
<div class="flex-grow-1 container-p-y ">
            ...
            <div class="col-md-7">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4" style="line-height: 1.6;">
                        ...
                        Program Pembinaan Mahasiswa Wirausaha (P2MW) adalah program yang bertujuan untuk
                        meningkatkan kemampuan dan keterampilan mahasiswa dalam berwirausaha. Program ini
                        memberikan pelatihan, pendampingan, dan dukungan kepada mahasiswa untuk mengembangkan
                        ide bisnis mereka, memulai usaha, dan mengelola bisnis secara efektif. P2MW juga
                        mendorong mahasiswa untuk berinovasi, berkolaborasi, dan menciptakan lapangan kerja
                        baru. Melalui program ini, diharapkan mahasiswa dapat menjadi wirausahawan yang
                        sukses dan berkontribusi pada perekonomian nasional.
                        <br>
    ...
    <div class="row">
        ...
        [
        'title' => 'Disetujui',
        'route' => route('admin.skpi.wirausaha.disetujui'),
        'color' => 'success',
        'svg' => '
        ...
        [
        'title' => 'Ditolak',
        'route' => route('admin.skpi.wirausaha.ditolak'),
        'color' => 'danger',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
        ...
        [
        'title' => 'Ditinjau',
        'route' => route('admin.skpi.wirausaha.ditinjau'),
        ...
        [
        'title' => 'Menunggu',
        'route' => route('admin.skpi.wirausaha.menunggu'),
        'color' => 'secondary',
        'svg' => '
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none">

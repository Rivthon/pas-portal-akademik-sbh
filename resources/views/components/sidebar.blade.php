<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @canany(['tarif-list', 'tenor-list', 'tagihan-list', 'aktivasi-list', 'aktivasi-uap-list', 'cuti-list'])
            <li
                class="menu-item @if(Route::is('admin.aktivasi.index') || Route::is('admin.aktivasi-uap.*') || Route::is('admin.cuti.*') || Route::is('admin.tarif.index') || Route::is('admin.tenor-pembayaran.index') || Route::is('admin.tagihan-mahasiswa.index')) active open @endif">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-book-bookmark"></i>
                ...
                <ul class="menu-sub">
                    ...
                    @endcan
                    @can('cuti-list')
                        <li class="menu-item @if(Route::is('admin.cuti.*')) active @endif">
                            <a href="{{ route('admin.cuti.index') }}" class="menu-link">
                                <div data-i18n="Validasi Cuti">Validasi Cuti</div>
                            </a>
                        </li>
                    @endcan
                </ul>

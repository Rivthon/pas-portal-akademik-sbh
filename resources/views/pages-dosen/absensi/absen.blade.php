...
<div class="container">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <h5 class="card-title text-primary fw-bold">
                <i class="bx bxs-book"></i> Informasi Mata Kuliah
            </h5>
            <div class="row">
    ...
    <h5 class="text-primary fw-bold mt-4">
        <i class="bx bxs-user-check"></i> Absensi Teori
    </h5>
    <!-- Form Tambah Mahasiswa yang Tidak Ada di Absensi -->
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <h5 class="card-title">Tambah Mahasiswa ke Absensi</h5>

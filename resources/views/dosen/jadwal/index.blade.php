            ...
            <div class="card-body">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-md-7 text-white p-3">
                        <h4 class="card-title mb-3 fw-bold text-white"><i class="bx bx-calendar me-2"></i>Jadwal Perkuliahan</h4>
                    ...
                    <div class="col-md-5 text-center d-none d-md-block">
                        <img src="{{ asset('assets/img/illustrations/calender.png') }}" class="img-fluid"
                            alt="Illustration for morning schedule" style="max-height: 150px;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm mb-4 border-0">
                ...
                <div class="row align-items-center gx-3">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <div class="input-group input-group-merge shadow-sm rounded-pill border">
                            <span class="input-group-text bg-white border-0 rounded-pill-start" id="basic-addon-search31"><i class="bx bx-search"></i></span>
                            <input type="text" id="filterNamaJadwal" class="form-control border-0 rounded-pill-end ps-0" placeholder="Cari Mata Kuliah atau Dosen..." aria-label="Search..." aria-describedby="basic-addon-search31">
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card-body bg-light mt-0 pt-4">
                <div id="noDataResult" class="alert alert-warning text-center d-none">
                    ...
                    Pencarian tidak menemukan jadwal yang sesuai.
                </div>
                <div id="jadwalContainer">
                    @include('dosen.jadwal.partial_list')
                </div>
            </div>
        </div>
    </div>
        ...
        function filterJadwal() {
            ...
            dayContainers.forEach(container => {
                ...
                cardsInDay.forEach(card => {
                    ...
                    // Sesuaikan string pencocokan: Regulernya 'reguler' atau kelas standar

...
<div class="row">
    <div class="col-xxl-12 mt-auto mb-auto order-0">
                ...
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-md-8 text-white p-3">
                        ...
                        <p class="mb-0 text-white-50" style="line-height: 1.6;">
                            Kelola materi perkuliahan, tugas, quiz, dan rekap penilaian (gradebook) berdasarkan pertemuan mata kuliah yang Anda ampu secara terstruktur.
                        </p>
                    </div>

                    <!-- Icon/Image Section -->
                    <div class="col-md-4 text-center d-none d-md-block">
                        <i class="bx bx-chalkboard text-white" style="font-size: 7rem; opacity: 0.3;"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <x-lms-calendar
            ...
            :store-route="route('dosen.lms.calendar.notes.store')"
            :update-route-template="route('dosen.lms.calendar.notes.update', ['note' => '__NOTE__'])"
            :destroy-route-template="route('dosen.lms.calendar.notes.destroy', ['note' => '__NOTE__'])"
            calendar-id="dosenLmsCalendar"
        />
        ...
        <div class="card shadow-sm mb-4 border-0">
                ...
                <div class="row align-items-center gx-3">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <div class="input-group input-group-merge shadow-sm rounded-pill border">
                            ...
                            <input type="text" id="filterLms" class="form-control border-0 rounded-pill-end ps-0" placeholder="Cari Mata Kuliah, Kode MK, atau Program Studi..." aria-label="Search...">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body bg-light mt-0 pt-4">
                ...
                <div id="noDataResult" class="alert alert-warning text-center d-none shadow-sm border-0">
                    ...
                    Pencarian tidak menemukan jadwal mata kuliah yang sesuai.
                </div>

                <x-lms-course-list :jadwal-list="$jadwalList" role="dosen" />
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const searchInput = document.getElementById('filterLms');

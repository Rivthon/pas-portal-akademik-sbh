...
<head>
    <meta charset="UTF-8">
    <title>Laporan Rekap Absensi Pertemuan Dosen</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h2>Laporan Rekap Absensi Pertemuan Dosen</h2>
            ...
            <tbody>
                @foreach($jadwal->pertemuan as $index => $pertemuan)
                    ...
                    <tr>
                        ...
                        <td>
                            <span
                                class="badge bg-label-{{ strtolower($pertemuan->metode_pbm ?: 'offline') === 'online' ? 'primary' : 'secondary' }}">
                                <i
                                    class="bx {{ strtolower($pertemuan->metode_pbm ?: 'offline') === 'online' ? 'bx-wifi' : 'bx-building' }} me-1"></i>

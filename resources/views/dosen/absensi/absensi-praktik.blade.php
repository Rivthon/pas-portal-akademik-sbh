...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow-sm border-0 bg-primary text-white" style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%);">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                        <div class="avatar avatar-md me-2">
                            <span class="avatar-initial rounded-circle bg-white text-primary"><i class="bx bxs-flask fs-4"></i></span>
                        </div>
                        <h4 class="card-title text-white mb-0 fw-bold">Informasi Absensi Praktikum</h4>
                    </div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h5 class="fw-bold text-dark mb-0"><i class="bx bxs-user-check text-primary me-2"></i>Daftar Hadir Praktikum</h5>
    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-md-4">
                        <button type="button" class="btn btn-primary shadow-sm w-100 rounded-pill" id="btnTambahMahasiswa">
                            <i class="bx bx-plus-circle me-1"></i> Masukkan ke Daftar Praktik
                        </button>
                    </div>
                </div>
            </form>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white pt-4 pb-3 border-bottom d-flex flex-column flex-md-row justify-content-between align-items-md-center">
            <h6 class="mb-3 mb-md-0 fw-bold text-dark"><i class="bx bx-list-check text-success me-2"></i>Form Pengisian Kehadiran Praktik</h6>

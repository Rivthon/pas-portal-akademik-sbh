                ...
                <div class="flex-grow-1 mt-3 mt-sm-5">
                    <div
                        ...
                        <div class="user-profile-info">
                            <h4>{{ auth('mahasiswa')->user()->nama }}</h4>
                            <ul
                                ...
                                <li class="list-inline-item fw-medium">
                                    ...
                                    {{ auth('mahasiswa')->user()->created_at?->translatedFormat('d F Y') }}
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <form action="{{ route('mahasiswa.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" id="nama"
                            ...
                            value="{{ old('nama', auth('mahasiswa')->user()->nama) }}" required>
                        @error('nama')
                    ...
                    <div class="mb-3">
                        <p>Avatar Saat Ini:</p>
                        <img src="{{ asset('storage/' . auth('mahasiswa')->user()->avatar) }}" alt="Avatar"

...
@section('title', 'Program Kreativitas Mahasiswa')
    ...
    <div class="card shadow-sm mb-4 border-0">
        <div class="row g-0 align-items-center">
            ...
            <div class="col-md-7">
                <div class="card-body">
                    <!-- Title -->
                    <h5 class="text-primary fw-bold mb-3">Program Kreativitas Mahasiswa</h5>
                    <!-- Breadcrumbs -->
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <small class="text-muted ms-2">(maksimal 20)</small>
                    </div>
                    ...
                    <a href="#" class="btn btn-primary d-inline-flex align-items-center gap-1" data-bs-toggle="modal"
                        ...
                        <i class="bx bx-send"></i> Ajukan Program Kreativitas Mahasiswa
                    </a>
                </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold text-uppercase" id="ajukanSertifikasiModalLabel">Ajukan PKM (Program
                        Kreativitas Mahasiswa)</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route ('mahasiswa.pkm.store') }}" method="POST" novalidate>
                    @csrf
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <select name="jenis_pkm" class="form-select" required>
                                    ...
                                    @foreach(['PKM-P', 'PKM-K', 'PKM-M', 'PKM-T', 'PKM-GT', 'PKM-AI', 'PKM-R', 'PKM-PI',
                                    'PKM-KC', 'PKM-PM', 'PKM-VGK','Lainnya'] as $j)
                                    <option value="{{ $j }}" @selected(old('jenis_pkm')==$j)>{{ $j }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 col-md-4">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="url" name="file_laporan" class="form-control"
                                    placeholder="https://drive.google.com/..." value="{{ old('file_laporan') }}"
                                    required>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <!-- Delete Button -->
                            <form action="{{ route('mahasiswa.delete.pkm', $row->id) }}" method="POST"
                                class="d-inline delete-sertifikasi-form">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-sm btn-icon btn-outline-danger btn-delete-pkm"
                                    title="Hapus">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title fw-bold"
                                                ...
                                                Detail PKM (Program Kreativitas Mahasiswa)
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                            <dl class="row mb-0 text-start">
                                                <dt class="col-sm-4">Judul Kegiatan</dt>
                                                <dd class="col-sm-8">: {{ $row->judul_kegiatan }}</dd>

                                                <dt class="col-sm-4">Jenis PKM</dt>
                                                <dd class="col-sm-8">: {{ $row->jenis_pkm }}</dd>
                                                ...
                                                <dd class="col-sm-8">
                                                    :
                                                    @if ($row->file_laporan)
                                                    <a href="{{ $row->file_laporan }}" target="_blank" rel="noopener">
                                                        Lihat Laporan
                                                    </a>
                                                    @else
                                                    -
                                                ...
                                                <dd class="col-sm-8">
                                                    ...
                                                    <a href="{{ route('mahasiswa.edit.pkm', $row->id) }}"

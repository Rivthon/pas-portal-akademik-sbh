                ...
                <div class="d-flex flex-column flex-md-row align-items-center g-0">
                    ...
                    <div class="col-md-7 p-4">
                        ...
                        <p class="mb-4 text-muted" style="line-height: 1.6;">
                            Temukan jadwal kuliah Anda dengan mudah. Jadwal ini mencakup seluruh informasi mata kuliah,
                            hari, waktu, dan ruang kelas untuk semester aktif saat ini.
                        </p>

                        <!-- Toggle Switcher -->
                        <div class="d-flex flex-wrap gap-2">
                            <a href="{{ route('mahasiswa.jadwal-kuliah.index') }}" class="btn btn-primary px-4 shadow-sm">
                                <i class='bx bx-book-reader me-1'></i> Kuliah Teori
                            </a>
                            <a href="{{ route('mahasiswa.jadwal-praktik.index') }}" class="btn btn-outline-primary px-4">
            ...
            @if($jadwalByDay->isEmpty())
                <div class="alert alert-warning d-flex align-items-center shadow-sm" role="alert">
                    ...
                    <div>
                        ...
                        Tidak ada jadwal kuliah yang tersedia untuk semester ini.
                    </div>
                </div>
            @else

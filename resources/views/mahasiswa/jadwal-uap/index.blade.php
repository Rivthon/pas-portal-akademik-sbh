    ...
    <div class="col-md-12">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body text-center">
                <h4 class="card-title text-danger mb-3">Akses Ditolak</h4>
                <p class="text-muted mb-3">Hanya mahasiswa semester 6 yang dapat melihat jadwal UAP.</p>
                <a href="{{ route('mahasiswa.dashboard') }}" class="btn btn-primary">Kembali ke Dashboard</a>
            </div>
        </div>
        @elseif($status_jadwal_uap == 0)
        <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted small mb-3">
                                <span class="me-3 fw-medium"><i class='bx bx-time-five me-1'></i>
                                    ...
                                    \Carbon\Carbon::parse($item->jam_selesai)->format('H:i') }}</span>
                            </p>
                            ...
                            <div class="mt-2 text-muted small d-flex flex-column gap-1">
                                <span class="d-flex align-items-center"><i
                                        class='bx bx-building-house me-2 text-primary'></i> {{ $item->programStudi->nama
                                    ?? '-' }}</span>
                                <span class="d-flex align-items-center"><i
                                        class='bx bx-calendar-event me-2 text-primary'></i> {{
                                    $item->tahunAkademik->nama ?? '-' }}</span>
                            </div>
                        </div>
                    </div>
                </div>

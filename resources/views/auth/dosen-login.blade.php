...
<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="row shadow-lg rounded overflow-hidden" style="max-width: 1100px; width: 100%;">
        ...
        <div class="col-md-6 bg-white p-5 d-flex flex-column align-items-center">
            ...
            <span class="text-center fw-light mb-4">Silakan login dengan NIDN atau Email serta Password Anda.</span>
            ...
            <form method="POST" action="{{ route('dosen.login') }}" class="w-100">
                @csrf
                <!-- Email atau NIDN Input -->
                <div class="mb-3">
                    <label for="email" class="form-label">NIDN atau Email</label>

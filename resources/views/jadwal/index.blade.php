...
<div class="card shadow-sm mb-4">
    <div class="card-body">
        <div class="row g-0 align-items-center">
            <!-- Content Section -->
            <div class="col-md-7">
                <h5 class="card-title text-primary mb-3 fw-bold">Jadwal Kuliah Akademik</h5>
                <p class="mb-4 text-muted" style="line-height: 1.6;">
                    Jadwal kuliah akademik adalah jadwal yang berisi informasi mengenai jadwal kuliah, ujian, dan
                    kegiatan akademik lainnya. Anda dapat melihat jadwal kuliah akademik di sini.
                </p>
...
<div class="card">
    <div class="container mt-4">
        <div id="jadwal-uts-container" class="row mb-4">
            <div class="col-md-6">
                <h5 class="card-title text-primary mb-3 fw-bold">Cari Jadwal Kuliah</h5>
            ...
            <div class="col-md-6">
                <h5 class="card-title text-primary mb-3 fw-bold">Import Data Jadwal Kuliah</h5>
...
<div class="card mt-4">
    <div class="card-body">
        <h5 class="card-title">List Jadwal Kuliah</h5>
            ...
            .then(data => {
                ...
                data.forEach(jadwal => {
                    ...
                    let row = `<tr data-id="${jadwal.id}">
                        ...
                        <td>
                            <span class="badge bg-primary">${jadwal.jenis_kelas}</span>
                        </td>

        ...
        <div class="row g-0 align-items-center">
            <div class="col-md-7">
                ...
                <p class="mb-4 text-muted" style="line-height: 1.6;">
                    Halaman ini digunakan untuk mengelola daftar matakuliah yang diajarkan pada masing-masing program studi dan semester.
            ...
            <div class="col-md-5 text-center">
                <img src="../assets/img/illustrations/kartu-study.png" class="img-fluid" alt="Illustration" style="max-height: 150px;">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body mt-3">
        ...
        <select style="display:none;" id="modal-master-select">
            ...
            @foreach($mataKuliah as $mata)
                <option value="{{ $mata->matakuliah_id }}" data-jurusan="{{ $mata->jurusan_id }}" data-smt="{{ $mata->smt }}">
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
            ...
            <div class="d-flex align-items-center">
                <span id="summary-count" class="badge bg-info me-3 py-2 px-3 fs-6" style="display: none;">0 mata kuliah dipilih</span>
...
<div class="card shadow-sm mt-4 border-top border-5 border-primary">
    <div class="card-header bg-white pb-0">
        <h5 class="card-title text-primary mb-0"><i class="bx bx-search me-1"></i> Cari & Tampilkan Daftar Mata Kuliah</h5>
    </div>
    <div class="card-body">
        <div class="row mt-3">
        ...
        <div class="mt-2 text-end">
            <button id="search-btn" class="btn btn-primary px-4"><i class="bx bx-search-alt me-1"></i> Tampilkan</button>
        </div>
...
<script>
    ...
    window.deleteRow = function(btn) {
        ...
        if (confirmation) {
            ...
            .catch(error => {
                // Since destroy returns a redirect instead of JSON normally,
                // if it fails to parse JSON, we might reload or re-search
                console.error('Error:', error);

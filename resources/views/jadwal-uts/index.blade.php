...
<div class="card">
    <div class="container mt-4">
        <div id="jadwal-uts-container" class="row mb-4">
            <div class="col-md-6">
                <h5 class="card-title text-primary mb-3 fw-bold">Cari Jadwal Ujian Tengah Semester</h5>
            ...
            <div class="col-md-6">
                <h5 class="card-title text-primary mb-3 fw-bold">Import Data Jadwal Ujian Tengah Semester</h5>
...
<div class="card mt-4">
    <div class="card-body">
        <h5 class="card-title">List Jadwal UTS</h5>
...
<script>
    document.getElementById('search-btn').addEventListener('click', function () {
        ...
        fetch(`{{ route('admin.jadwal-uts.filter') }}?programStudi=${programStudi}&semester=${semester}`)
    ...
    function updateJadwalUTS(id, field, value) {
        fetch(`{{ url('/admin/jadwal-uts/update') }}/${id}`, {
            method: 'POST',
            headers: {
